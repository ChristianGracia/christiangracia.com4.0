...
const CG: Site = new Site(
  ...
  "https://www.github.com/ChristianGracia/christiangracia.com4.0"
);
...
const CG_API: Site = new Site(
  ...
  "https://www.github.com/ChristianGracia/christiangracia-api"
);

const ALGORITHMS: Site = new Site(
  "Algorithms",
  "Doing review of Data Structures and Algorithms",
  "https://www.github.com/ChristianGracia/Algorithms"
);
